...
// Prints all particles' position to the output. We could instead draw them on screen in a more interesting application.
...
void RunSimulation(void) {
    ...
    while (currentTime < totalSimulationTime) {
        // We're sleeping here to keep things simple. In real applications you'd use some timing API to get the current time in milliseconds and compute dt in the beginning of every iteration like this:
        // currentTime = GetTime()
